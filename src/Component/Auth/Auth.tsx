        ...
        <div className="container">
            <form action="" className="form_main" onSubmit={handleSubmit}>
                ...
                <div className="inputContainer">
                    ...
                    <input type="phone" className="inputField" id="phone" placeholder="Số điện thoại"
                        name="phone"
                ...
                <div className="inputContainer">
                    ...
                    <input type="name" className="inputField" id="name" placeholder="Họ và tên"
                        name="name"
                        value={formData.name}
                        onChange={handleChange} required />
                </div>
                ...
                <div className="inputContainer">
                    ...
                    <input type="number" className="inputField" id="status" placeholder="Status"
                        name="status"
